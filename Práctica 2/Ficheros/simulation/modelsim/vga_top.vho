...
SIGNAL \VGA|cont_vs[6]~1_combout\ : std_logic;
...
SIGNAL \VGA|cont_vs[5]~0_combout\ : std_logic;
...
SIGNAL \VGA|vga_b~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \VGA|process_0~2_combout\ = (!\VGA|cont_hs\(8) & (\VGA|cont_hs\(9) & \VGA|cont_hs\(7)))
...
-- Equation(s):
-- \VGA|process_0~4_combout\ = (((\VGA|cont_vs\(2)) # (\VGA|cont_vs\(4))) # (!\VGA|cont_vs\(3))) # (!\VGA|cont_vs\(1))
...
\VGA|cont_vs[6]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|cont_vs[6]~1_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(6))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~12_combout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \VGA|process_0~10_combout\,
	datab => \VGA|Equal2~2_combout\,
	datac => \VGA|cont_vs\(6),
	datad => \VGA|Add1~12_combout\,
	combout => \VGA|cont_vs[6]~1_combout\);

-- Location: LCCOMB_X40_Y72_N12
\VGA|cont_vs[1]~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|cont_vs[1]~8_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & ((\VGA|cont_vs\(1)))) # (!\VGA|Equal2~2_combout\ & (\VGA|Add1~2_combout\))))
...
-- Equation(s):
-- \VGA|Equal0~1_combout\ = (\VGA|cont_hs\(3) & (!\VGA|cont_hs\(5) & (\VGA|cont_hs\(1) & \VGA|cont_hs\(2))))
...
-- Equation(s):
-- \VGA|Equal0~0_combout\ = (\VGA|cont_hs\(9) & (!\VGA|cont_hs\(6) & (\VGA|cont_hs\(4) & \VGA|cont_hs\(0))))
...
-- Equation(s):
-- \VGA|Equal0~2_combout\ = (!\VGA|cont_hs\(7) & (\VGA|Equal0~1_combout\ & (\VGA|Equal0~0_combout\ & \VGA|cont_hs\(8))))
...
-- Equation(s):
-- \VGA|cont_vs[3]~7_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(3))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~6_combout\)))))
...
\VGA|cont_vs[7]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|cont_vs[7]~2_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(7))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~14_combout\)))))
...
PORT MAP (
	...
	combout => \VGA|cont_vs[7]~2_combout\);
...
\VGA|cont_vs[8]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|cont_vs[8]~3_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(8))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~16_combout\)))))
...
PORT MAP (
	...
	combout => \VGA|cont_vs[8]~3_combout\);
...
\VGA|cont_vs[9]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|cont_vs[9]~4_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(9))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~18_combout\)))))
...
PORT MAP (
	...
	combout => \VGA|cont_vs[9]~4_combout\);
...
-- Equation(s):
-- \VGA|process_0~0_combout\ = (\VGA|cont_vs\(9)) # ((\VGA|cont_hs\(9) & ((\VGA|cont_hs\(7)) # (\VGA|cont_hs\(8)))))
...
-- Equation(s):
-- \VGA|cont_vs[2]~6_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & ((\VGA|cont_vs\(2)))) # (!\VGA|Equal2~2_combout\ & (\VGA|Add1~4_combout\))))
...
-- Equation(s):
-- \VGA|process_0~7_combout\ = (!\VGA|cont_vs\(6) & (!\VGA|cont_vs\(5) & (!\VGA|cont_vs\(7) & \VGA|cont_vs\(2))))
...
-- Equation(s):
-- \VGA|cont_vs[0]~9_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(0))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~0_combout\)))))
...
-- Equation(s):
-- \VGA|cont_vs[4]~5_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & (\VGA|cont_vs\(4))) # (!\VGA|Equal2~2_combout\ & ((\VGA|Add1~8_combout\)))))
...
-- Equation(s):
-- \VGA|process_0~6_combout\ = (!\VGA|cont_vs\(1) & (\VGA|cont_vs\(3) & (!\VGA|cont_vs\(0) & !\VGA|cont_vs\(4))))
...
-- Equation(s):
-- \VGA|process_0~8_combout\ = (\VGA|cont_hs\(7) & ((\VGA|cont_hs\(6)) # ((\VGA|cont_hs\(4) & \VGA|cont_hs\(5)))))
...
-- Equation(s):
-- \VGA|process_0~9_combout\ = (\VGA|process_0~7_combout\ & (\VGA|process_0~6_combout\ & ((\VGA|cont_hs\(8)) # (\VGA|process_0~8_combout\))))
...
\VGA|process_0~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|process_0~10_combout\ = (!\VGA|cont_vs\(8) & (\VGA|process_0~9_combout\ & (\VGA|cont_hs\(9) & \VGA|cont_vs\(9))))
...
\VGA|cont_vs[5]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|cont_vs[5]~0_combout\ = (!\VGA|process_0~10_combout\ & ((\VGA|Equal2~2_combout\ & ((\VGA|cont_vs\(5)))) # (!\VGA|Equal2~2_combout\ & (\VGA|Add1~10_combout\))))
...
PORT MAP (
	...
	datab => \VGA|Equal2~2_combout\,
	datac => \VGA|cont_vs\(5),
	datad => \VGA|process_0~10_combout\,
	combout => \VGA|cont_vs[5]~0_combout\);
...
-- Equation(s):
-- \VGA|process_0~1_combout\ = (!\VGA|process_0~0_combout\ & !\VGA|LessThan6~0_combout\)
...
-- Equation(s):
-- \VGA|vga_r~feeder_combout\ = \VGA|video_on~q\
...
-- Equation(s):
-- \VGA|vga_g~feeder_combout\ = \VGA|video_on~q\
...
\VGA|vga_b~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \VGA|vga_b~feeder_combout\ = \VGA|video_on~q\
...
PORT MAP (
	datad => \VGA|video_on~q\,
	combout => \VGA|vga_b~feeder_combout\);
...
-- Equation(s):
-- \VGA|process_0~3_combout\ = ((\VGA|cont_hs\(6) & (\VGA|cont_hs\(4) & \VGA|cont_hs\(5))) # (!\VGA|cont_hs\(6) & (!\VGA|cont_hs\(4) & !\VGA|cont_hs\(5)))) # (!\VGA|process_0~2_combout\)
...
-- Equation(s):
-- \VGA|process_0~5_combout\ = (\VGA|process_0~4_combout\) # ((\VGA|cont_vs\(9)) # (!\VGA|LessThan6~0_combout\))
