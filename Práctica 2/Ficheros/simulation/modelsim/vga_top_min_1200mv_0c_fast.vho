...
-- Equation(s):
-- \VGA|process_0~8_combout\ = (\VGA|cont_hs\(7) & ((\VGA|cont_hs\(6)) # ((\VGA|cont_hs\(5) & \VGA|cont_hs\(4)))))
...
-- Equation(s):
-- \VGA|Equal2~2_combout\ = (\VGA|cont_hs\(3)) # ((\VGA|Equal2~0_combout\) # ((\VGA|Equal2~1_combout\) # (!\VGA|cont_hs\(5))))
